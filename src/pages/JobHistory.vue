...
export default {
  ...
  computed: {
    ...
    columns() {
      ...
      if (this.$route.params.type === 'history') {
        cols.push({ name: 'id', label: this.$t('id'), field: (r) => r.meta.id, align: 'left', sortable: true, headerClasses: 'q-table--col-auto-width' })
        cols.push({ name: 'prompt', label: this.$t('prompt'), field: (r) => r.workloadOptions.prompt, align: 'left', sortable: true })
        cols.push({ name: 'workload', label: this.$t('workload'), field: (r) => r.workloadDefinition.name, align: 'left', sortable: true, headerClasses: 'q-table--col-auto-width' })
        cols.push({ name: 'status', label: this.$t('status'), field: 'status', align: 'left', sortable: true, headerClasses: 'q-table--col-auto-width' })
      } else {
        cols.push({ name: 'name', label: this.$t('name'), field: (r) => r.workloadDefinition.name, align: 'left', sortable: true, headerClasses: 'q-table--col-auto-width' })
        cols.push({ name: 'description', label: this.$t('description'), field: (r) => r.workloadDefinition.description, align: 'left', sortable: true })
        cols.push({ name: 'codename', label: this.$t('codename'), field: (r) => r.workloadDefinition.codename, align: 'left', sortable: true, headerClasses: 'q-table--col-auto-width' })
      }
